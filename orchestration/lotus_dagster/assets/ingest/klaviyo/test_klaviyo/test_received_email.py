# assets/ingest/klaviyo/test_received_email.py
import os
import sys
import json
import logging
...
def main():
    """Test harness for the Klaviyo Received Email event extractor."""
    ...
    try:
        result = extract_received_email_query_fn(client, last_sync_time)
